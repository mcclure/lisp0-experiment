This document extends [language.md](./language.md) with details which are relevant to writing an interpreter of this (unstable, unnamed) language, but unhelpful when writing code.
...
Except in the interior of strings or comments, and except that U+FEFF is allowed as opening BOM:
...
As of the second I am writing these words, I have not checked the accuracy of this document as carefully as I have `language.md`.